...
app.get('/all', (req, res)=>{res.send(foodData)})
app.get('/vegetable', (req, res)=>{res.send(veges)})
app.get('/fruit',(req, res)=>{res.send(fruits)})
app.get('/protein',(req, res)=>{res.send(proteinfood)})
app.get('/calorie-above-100',(req, res)=>{res.send(calabove100)})
app.get('/calorie-below-100',(req, res)=>{res.send(calbelow100)})
app.listen(5500, ()=> {})